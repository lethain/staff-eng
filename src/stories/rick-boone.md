...
[twitter](https://twitter.com/kineticrick)

___Tell us a little about your current role: where do you work, your title and generally the sort of work do you and your team do.___

I’m the Strategic Advisor to Uber’s Vice President of Infrastructure, which means I’m part of the Infrastructure leadership team along with the engineering directors and Technical Program Managers. Infrastructure Engineering at Uber is about 700 people across six sub-organizations like Metal which handles our data centers and servers, Storage, Developer Platform and so on. I work with the VP on things like technical strategy, cultural strategy and special projects.
...
Although right now it’s just me, previously there were two of us in the Strategic Advisor to VP Infrastructure role, and we would split the work based on our natural affinity to the projects. She often focused more on managerial projects and me on engineering projects.

The Special Advisor role is a bit unorthodox that was created by [Matthew Mengerink](https://eng.uber.com/core-infra-2018/) when he started in the VP of Infrastructure role, and for now we’re the only organization with the role. Matthew created it because he knew he didn’t have the full context from within the engineering teams themselves, and he wanted to create that feedback loop to inform his decision making.
...
This is an interesting question because I was thinking about a similar question the other day, “How is my role different than being a Chief of Staff?” Infrastructure at Uber has all three roles: Strategic Advisor, Chief of Staff and Technical Program Managers, and we all work together closely.

The way I see it, TPM is more of an organization-scoped operational role. They operate at a high-level, looking at the full chessboard, and figure out which pieces to keep in place and which to move according to our latest priorities. The Chief of Staff role focuses on translating decisions from the Infrastructure leadership team into execution.

My role is more about taking broad domain knowledge, getting into the details of the problems on a personal and organizational level, and then mixing in engineering acumen. From that I’ll synthesize a set of recommendations or insight to make a recommendation to the Infrastructure leadership team.

**_How do you think about the importance of remaining aligned with your sponsor?_**

It’s funny, because I’m doing a deep examination of this question right now. Matthew and I are very aligned on our principles, values, world views, emphasis on emotional intelligence, approach to execution, and philosophies. On so many things we’re lined up, such that it’s almost a symbiotic relationship.
...
In my role we’ll often go weeks without being in the same room together, but I still have to operate as if I’m his direct proxy. So I go into a room and think, “What would Matthew do here? What is the question he would want to ask? What guidance has he given on this problem?” Because I can’t always run back to him for clarification, it’s essential to develop and maintain a deep understanding of his world view. That’s essential for me to retain the very deep trust required to be his representative and effectively carry out his strategy and vision. People need to be confident that I’ll always give the same answer that Matthew would give he was there.

It also means that I have to truly understand his values and principles, to make sure that I’m ready to stake my reputation on pushing them forward. Something this is helping translate between his vision and how folks have interpreted it, particularly when some of the context behind the vision gets lost.

To be honest, this is something I struggled with a lot when I started in the role. Matthew would constantly tell, “You my representative, and you should go push on these things as if you were me.” That was difficult for me because I’ve never been in a role like that before. Previously I’ve always operated using my own reputation, and now I had to operate with the aegis of the Vice President and his authority. Over time I’ve learned how to be deliberate with using that hammer, since you don’t want to overuse it.

I’ve also learned that I have to let folks know which hat I’m wearing sometimes. I love to mentor people, but sometimes folks aren’t sure if they’re getting Strategic Advisor Rick or Mentor Rick, and I try to let them know which role I’m currently in. If I meet with someone I’m mentoring, they might want to get advice about leaving the company, and they want to know which perspective I’m giving advice from.

**_What does a “normal” Staff-plus engineer do at your company? Does your role look that way or does it differ?_**

I think the biggest difference is that other senior-plus engineers work primarily on technical work. They are leaders, so they do get into the realm of emotional intelligence, communication, collaboration, conflict resolution, evangelism and so on, but still 80% of their efforts are driven by technical concerns.

Whereas with me, there might be weeks where I’m focused on a project around group psychology or organizational design. Technical concerns are not always the pure focus that drive my day to day.

**_How do you stay aware of reality on the ground now that you’re developing less?_**

When I was an engineer I could do this passively, because you’re in the code, trying to push commits, dealing with the friction of provisioning and operating services. That doesn’t work anymore, and now it requires an active process.
...
One is that I give an Engucation (what happens when you blend engineering and education into a single word) presentation every month to most new hires in engineering, and let people know my email and that they’re welcome to reach out. A good number reach out to me after that and I give them advice on their careers, working at Uber, or whatever. Other times I’ll have people who just run into me while I’m around the office and ask for advice.

I want to be visible as a black engineer, showing others that we _are_ here and this _is_ doable. Once I realized this was an important motivation for me, I knew that I had to get better at public speaking, because that’s such an important way to scale myself as a role model. Public speaking used to terrify me. I used to _hate_ public speaking. But because it’s such a key way to reach large numbers of people, I told myself I had to learn to like it, and since then I’ve learned to be an effective public speaker.
...
My path was completely unorthodox. It wasn’t planned, and there really isn’t a reproducible pathway to it, more of a fortunate series of events. Previously [Rob Punkunus](https://www.linkedin.com/in/rob-punkunus-3791273/) was in the same role, and when he decided to leave he was asked to suggest potential successors. He suggested me and Kate, and both of us ended up serving in the Strategic Advisor role.
...
In addition to Rob’s recommendation, the most important factor was doing visible work that aligned with Matthew’s values. One project I worked on was joining the working group to define SRE’s culture back in 2017. The working group was already planned before [Susan Fowler’s blog post](https://www.susanjfowler.com/blog/2017/2/19/reflecting-on-one-very-strange-year-at-uber) went out, and our first meeting was three days after she posted it. In my humble opinion, the culture working group did great work, and over eighteen months we really moved the culture of a hundred person organization in a meaningful way.
...
For me it’s been important to follow my passions. Recently that’s been around mentorship, but it’s also been around other things like machine learning has always been a hobby of mine. I love how machines can generate insights that shape how people think.

So I have these passions that I stoke, and then when opportunities to align those passions with something the company needs arise, I take them. For example, my previous team at Uber was generating insights into fleet utilization for capacity planning purposes, and was a great chance to pull together my interest in machine learning and site reliability.
...
It’s something that I think about sometimes, even know it’s something I’m thinking about. It’s on my list of possibilities, and throughout my career folks have told me, “You’d be a great manager.” or asked, “Have you considered moving into management?”
...
You know, for the first two-thirds of my career I used to love reading as much technical content as I could. I would be on YCombinator reading all day reading about distributed systems or whatever. These days I’m much more into reading about behavioral economics, behavioral science, human psychology, organizational strategy and so on. I’ve been reading a lot of [Daniel Kahneman](https://en.wikipedia.org/wiki/Daniel_Kahneman) lately.
