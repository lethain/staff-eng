...
I’m honestly a bit sad that people treat me differently now based on my role. I have a lot of power, but I’m also lonelier at work. It’s also a bit disconcerting that some folks take my opinions more seriously and are nicer to me than when I wasn’t in such a visible role. Previously, there were cases where people weren’t collaborative or actively dismissed my opinions. It was actually pretty eye-opening to experience this. I was confident enough (and trusted enough by the organization) to give them strong feedback on their collaboration so that I could ensure things like this weren’t happening to others like me. I now worry that I’m losing visibility into where these interactions are happening.
...
Later on I realized that during that time, while I wasn’t efficiently mapping towards growing on the technical side of being a software engineer, I was actually learning critical skills that allowed me to move very quickly from senior to Staff, and from Staff to my current role (together, this only took 3 years!). I slowly and deliberately built out my technical foundation when I worked on the first versions of [Stripe Radar](https://stripe.com/radar) and [Stripe Elements](https://stripe.com/payments/elements). Technical skills feel extremely learnable just by doing and by being deliberate. The softer skills, the connections across the company, the user focus, understanding the product deeply—these are the skills that took much longer to learn and ultimately helped me accelerate my path to Staff after I built my technical foundation
